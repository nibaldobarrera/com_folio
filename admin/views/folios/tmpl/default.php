...
<form action="<?php echo JRoute::_('index.php?option=com_folio&view=folios'); ?>"
		...
		<div id="filter-bar" class="btn-toolbar">
			...
			<div class="btn-group pull-left">
				...
				<button class="btn hasTooltip" type="button" title="
					<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>" onclick="document.id('filter_search').value='';this.form.submit();"><i class="icon-remove"></i>
				</button>
			</div>
			...
			<tbody>
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="1">
					...
					<?php if ($canChange) :
						...
						<?php echo $item->ordering;?>" class="width-20 textarea-order " />
					<?php else : ?>
