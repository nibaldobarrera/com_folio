...
class com_folioInstallerScript
{
	function createSampleImages()
	{
		...
		if(!file_exists(JPATH_SITE."/images/com_folio/moneda.png"))
		{
			JFile::copy(JPATH_SITE."/media/com_folio/images/moneda.png",JPATH_SITE."/images/com_folio/moneda.png");
		};
		if(!file_exists(JPATH_SITE."/images/com_folio/galleta.png"))
		{
			JFile::copy(JPATH_SITE."/media/com_folio/images/galleta.png",JPATH_SITE."/images/com_folio/galleta.png");
		};
	}
