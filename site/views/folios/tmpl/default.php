		...
		<div class="folio_element">
			<?php switch ($this->params->get('target'))
			{
				case 1:
					...
					echo '<a href="'. $item->url .'" target="_blank" rel="nofollow">'.'<img src="'. $item->image .'" width="'.$imagewidth.'"></a>';
					break;
				case 2:
				...
				case 3:
					...
					<img src="<?php echo $item->image; ?>" width="'.$imagewidth.'"></a>
					<?php
					break;
				default:
					// open in parent window
					echo '<a href="'.  $item->url . '" rel="nofollow">'.'<img src="'. $item->image .'" width="150"></a>';
					break;
			}
			?>
		</div>
